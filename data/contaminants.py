...
CONTAMINANTS = {
    ...
    "chlorpyrifos": {
        ...
        "aliases": ["chlorpyrifos", "dursban", "lorsban"],
        "pdp_codes": [297],
        "units": "ppb",
        "risk_thresholds": {"high": 500, "medium": 100, "low": 0},
        "regulatory_flags": [
            {"jurisdiction": "US_Federal", "flag_type": "us_banned", "regulatory_body": "EPA",
             "regulation_citation": "40 CFR 180.342 (revoked 2021)", "notes": "EPA revoked all food tolerances for chlorpyrifos (August 2021)"},
            {"jurisdiction": "California", "flag_type": "state_banned", "regulatory_body": "CDPR",
             "notes": "Banned in California (2020)"},
        ],
        "fda_status": "banned_final_rule",
    },
    "acetamiprid": {
    ...
    "metolachlor": {
        "type": "pesticide",
        "cas_number": "51218-45-2",
        "display_name": "Metolachlor",
        "pdp_codes": [506],
        "units": "ppb",
        "risk_thresholds": {"high": 500, "medium": 100, "low": 0},
        "fda_status": "permitted",
