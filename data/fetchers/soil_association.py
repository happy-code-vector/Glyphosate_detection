...
SA_CERTIFIED_PRODUCTS = [
    ...
    ("Organic Semi-Skimmed Milk", "Yeo Valley", "dairy", 2020),
    ("Organic Butter", "Yeo Valley", "butter", 2020),
    ("Organic Greek Yogurt", "Yeo Valley", "dairy", 2020),
    ("Organic Natural Yogurt", "Yeo Valley", "dairy", 2020),
    ("Organic Whole Milk", "Rachel's", "dairy", 2020),
    ("Organic Semi-Skimmed Milk", "Rachel's", "dairy", 2020),
    ("Organic Yogurt", "Rachel's", "dairy", 2020),
    ...
    ("Organic Peppers", "Various", "pepper", 2020),
    ("Organic Cucumber", "Various", "cucumber", 2020),
    # ── Meat and Poultry ───────────────────────────────────────────────
    ("Organic Chicken Breast", "Various", "chicken", 2020),
    ("Organic Beef Mince", "Various", "cattle", 2020),
    ("Organic Pork Sausages", "Heck", "hog, meat", 2020),
    ("Organic Bacon", "Various", "hog, meat", 2020),
    # ── Tinned and Packaged ────────────────────────────────────────────
