...
class GermanyBVLFetcher(BaseFetcher):
    ...
    def _map_german_commodity(name: str) -> str:
        ...
        mappings = {
            ...
            "nelken": "cloves",
            "pfeffer (schwarz, grün und weiß)": "pepper",
            "pfeffer, schwarz und weiß": "pepper",
            "majoran": "marjoram",
            "salbei": "sage",
            "estragon": "tarragon",
            "anis": "anise",
            ...
            "pfefferminze": "mint",
            # Nuts and seeds
            "paranüsse": "brazil_nuts",
            "kaschüsse": "cashew",
            "macadamianüsse": "macadamia",
            "pekannüsse": "pecan",
            "pinienkerne": "pine_nuts",
            "kürbiskerne": "pumpkin",
            "kürbiskernöl": "pumpkin",
            "hanfsamen": "hemp_seeds",
            ...
            "datteln": "dates",
            "datteln, getrocknet": "dates",
            "feigen": "fig",
            "mirabellen": "mirabelle_plum",
            "johannisbeeren": "currants",
            "heidelbeeren": "blueberries",
            "oliven": "table olives",
            # Beverages
            "johannisbeernektar": "currants",
            "johannisbeersaft": "currant_juice",
            "holunderbeersaft": "elderberry_juice",
            "wein": "grape",
            "kaffee": "coffee",
            "kakao": "cocoa",
            "kakaopulver": "cocoa",
            ...
            "säuglingsanfangsnahrungen": "baby_food",
            "folgenahrungen für säuglinge": "baby_food",
            "komplettmahlzeiten, beikost u. sonst. f. säuglinge/kleinkinder": "baby_food",
        }
