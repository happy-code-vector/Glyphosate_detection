...
NON_GMO_PRODUCTS = [
    ...
    # ── Dairy ──────────────────────────────────────────────────────────
    ("Non-GMO Whole Milk", "Organic Valley", "dairy", 2020),
    ("Non-GMO 2% Milk", "Organic Valley", "dairy", 2020),
    ("Non-GMO Butter", "Organic Valley", "butter", 2020),
    ("Non-GMO Cheese", "Organic Valley", "dairy", 2020),
    ("Non-GMO Yogurt", "Stonyfield", "dairy", 2020),
    ("Non-GMO Greek Yogurt", "Chobani", "dairy", 2020),
    # ── Eggs ───────────────────────────────────────────────────────────
    ("Non-GMO Free Range Eggs", "Pete and Gerry's", "egg", 2020),
    ("Non-GMO Cage Free Eggs", "Nellie's", "egg", 2020),
    # ── Meat and Poultry ───────────────────────────────────────────────
    ("Non-GMO Chicken Breast", "Applegate", "chicken", 2020),
    ("Non-GMO Turkey Breast", "Applegate", "poultry", 2020),
    ("Non-GMO Beef Hot Dogs", "Applegate", "cattle", 2020),
    ("Non-GMO Ground Beef", "Applegate", "cattle", 2020),
    # ── Canned and Packaged ────────────────────────────────────────────
    ("Non-GMO Diced Tomatoes", "Muir Glen", "tomato", 2020),
    ("Non-GMO Tomato Sauce", "Muir Glen", "tomato", 2020),
    ("Non-GMO Tomato Paste", "Muir Glen", "tomato", 2020),
    ...
    # ── Drinks ─────────────────────────────────────────────────────────
    ("Non-GMO Orange Juice", "Tropicana", "orange", 2020),
    ("Non-GMO Apple Juice", "Mott's", "apple", 2020),
    ("Non-GMO Almond Milk", "Silk", "almond", 2020),
    ...
    ("Non-GMO Potato Chips", "Lay's", "potato", 2020),
    ("Non-GMO Potato Chips", "Kettle Brand", "potato", 2020),
]
