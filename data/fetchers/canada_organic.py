...
CANADA_ORGANIC_PRODUCTS = [
    ...
    # ── Dairy ──────────────────────────────────────────────────────────
    ("Organic Whole Milk", "Organic Meadow", "dairy", 2020),
    ("Organic 2% Milk", "Organic Meadow", "dairy", 2020),
    ("Organic Butter", "Organic Meadow", "butter", 2020),
    ("Organic Cream", "Organic Meadow", "dairy", 2020),
    ("Organic Yogurt", "Liberte", "dairy", 2020),
    ("Organic Greek Yogurt", "Liberte", "dairy", 2020),
    # ── Eggs ───────────────────────────────────────────────────────────
    ("Organic Free Range Eggs", "Organic Meadow", "egg", 2020),
    ("Organic Cage Free Eggs", "Born 3", "egg", 2020),
    ...
    # ── Drinks ─────────────────────────────────────────────────────────
    ("Organic Orange Juice", "Various", "orange", 2020),
    ("Organic Apple Juice", "Various", "apple", 2020),
    ("Organic Coffee", "Kicking Horse", "coffee", 2020),
    ("Organic Tea", "Red Rose", "tea", 2020),
]
