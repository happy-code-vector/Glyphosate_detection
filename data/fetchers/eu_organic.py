...
EU_ORGANIC_PRODUCTS = [
    ...
    # ── Dairy ──────────────────────────────────────────────────────────
    ("Organic Whole Milk", "Arla", "fresh_fruit", 2020),
    ("Organic Semi-Skimmed Milk", "Arla", "fresh_fruit", 2020),
    ("Organic Butter", "Arla", "butter", 2020),
    ("Organic Yogurt", "Arla", "fresh_fruit", 2020),
    ("Organic Whole Milk", "Yeo Valley", "fresh_fruit", 2020),
    ("Organic Butter", "Yeo Valley", "butter", 2020),
    ("Organic Yogurt", "Yeo Valley", "fresh_fruit", 2020),
    ("Organic Cheese", "Yeo Valley", "fresh_fruit", 2020),
