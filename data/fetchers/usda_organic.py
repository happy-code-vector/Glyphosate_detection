...
USDA_ORGANIC_PRODUCTS = [
    ...
    # ── Dairy ──────────────────────────────────────────────────────────
    ("Organic Whole Milk", "Organic Valley", "dairy", 2020),
    ("Organic 2% Milk", "Organic Valley", "dairy", 2020),
    ("Organic Butter", "Organic Valley", "dairy", 2020),
    ("Organic Cheese", "Organic Valley", "dairy", 2020),
    ("Organic Sour Cream", "Organic Valley", "dairy", 2020),
    ("Organic Whole Milk", "Stonyfield", "dairy", 2020),
    ("Organic Yogurt", "Stonyfield", "dairy", 2020),
    ("Organic Greek Yogurt", "Stonyfield", "dairy", 2020),
    ("Organic Kids Yogurt", "Stonyfield", "dairy", 2020),
    # ── Eggs ───────────────────────────────────────────────────────────
    ("Organic Free Range Eggs", "Pete and Gerry's", "egg", 2020),
    ("Organic Cage Free Eggs", "Nellie's", "egg", 2020),
    ("Organic Pasture Raised Eggs", "Vital Farms", "egg", 2020),
    # ── Meat and Poultry ───────────────────────────────────────────────
    ("Organic Chicken Breast", "Applegate", "chicken", 2020),
    ("Organic Turkey Breast", "Applegate", "poultry", 2020),
    ("Organic Beef Hot Dogs", "Applegate", "cattle", 2020),
    ("Organic Chicken", "Bell & Evans", "chicken", 2020),
    ("Organic Ground Beef", "Organic Prairie", "cattle", 2020),
    # ── Fruit and Vegetables ───────────────────────────────────────────
    ("Organic Baby Spinach", "Earthbound Farm", "spinach", 2020),
    ("Organic Spring Mix", "Earthbound Farm", "lettuce", 2020),
    ("Organic Kale", "Earthbound Farm", "kale", 2020),
    ("Organic Mixed Greens", "Earthbound Farm", "lettuce", 2020),
    ("Organic Strawberries", "Driscoll's", "strawberry", 2020),
    ("Organic Blueberries", "Driscoll's", "blueberry", 2020),
    ("Organic Raspberries", "Driscoll's", "raspberry", 2020),
    ("Organic Blackberries", "Driscoll's", "blackberry", 2020),
    # ── Canned and Packaged ────────────────────────────────────────────
    ("Organic Diced Tomatoes", "Muir Glen", "tomato", 2020),
    ("Organic Tomato Sauce", "Muir Glen", "tomato", 2020),
    ("Organic Tomato Paste", "Muir Glen", "tomato", 2020),
    ("Organic Crushed Tomatoes", "Muir Glen", "tomato", 2020),
    ...
    # ── Drinks ─────────────────────────────────────────────────────────
    ("Organic Orange Juice", "Uncle Matt's", "orange", 2020),
    ("Organic Apple Juice", "Martinelli's", "apple", 2020),
    ("Organic Green Tea", "Traditional Medicinals", "tea", 2020),
    ("Organic Chamomile Tea", "Traditional Medicinals", "tea", 2020),
    ("Organic Coffee", "Equal Exchange", "coffee", 2020),
    ("Organic Coffee", "Newman's Own", "coffee", 2020),
    # ── Baby Food ──────────────────────────────────────────────────────
    ...
    ("Organic Potato Chips", "Kettle Brand", "potato", 2020),
    # ── Condiments ─────────────────────────────────────────────────────
    ("Organic Ketchup", "Annie's", "tomato", 2020),
    ("Organic Mustard", "Annie's", "mustard seeds", 2020),
    ("Organic BBQ Sauce", "Annie's", "tomato", 2020),
    ("Organic Pasta Sauce", "Amy's", "tomato", 2020),
    ("Organic Salsa", "Amy's", "tomato", 2020),
    # ── Frozen ─────────────────────────────────────────────────────────
    ("Organic Frozen Pizza", "Amy's", "wheat", 2020),
    ("Organic Frozen Burrito", "Amy's", "wheat", 2020),
    ("Organic Frozen Vegetables", "Cascadian Farm", None, 2020),
    ("Organic Frozen Berries", "Cascadian Farm", "blueberry", 2020),
